...
* Design comprehensive test cases based on requirements.
* Apply BVA and EP test design techniques.
...
* Create and maintain the Requirement Traceability Matrix (RTM).
...
* Test cases can be traced back to requirements.
...
* Requirement analysis using FRS.
...
All supporting QA artifacts, including the FRS, 100+ test cases, test scenarios, test execution report, bug reports, RTM, Jira evidence, and screenshots, are maintained in this repository.


# Project Type

Manual Testing | Functional Testing | E-Commerce Testing | FRS | Test Case Design | BVA | EP | Jira | RTM | Defect Management 
